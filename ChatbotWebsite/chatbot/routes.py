...
def chat():
    ...
    if current_user.is_authenticated:
        ...
        image_data = current_user.profile_image  # BLOB from DB
        # Convert to base64 string
        if image_data:
            profile_image_base64 = base64.b64encode(image_data).decode('utf-8')
        else:
            profile_image_base64 = None  # or set a default image
    messages = None
